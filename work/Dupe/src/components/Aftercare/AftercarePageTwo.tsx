import Model from '../../assets/Images/Aftercare/AftercareModel2.png'
import Button from '../ui/Button'

function AftercarePageTwo() {
  return (
    <div className="md:min-h-screen overflow-hidden bg-[#F6F8FA] w-full font-['Inter'] px-8 py-12 md:p-20 flex">
        <div className='flex border-[1.2vw] border-dark-pink py-12 flex-col-reverse md:flex-row'>
            <div className='md:w-1/2 md:scale-150 mb-[-13.5vw] md:mb-0  mt-4 md:mt-[21.9vw] xl:mt-[4.9vw] md:pl-[2vw]'>
                <img src={Model} alt="Not Available" />
            </div>
            <div className='flex flex-col items-center justify-center md:w-2/3 gap-2 md:gap-8'>
                <h1 className='text-[7vw] md:text-[5vw] font-extrabold leading-none'>Do you want to <br /> become a Model?</h1>
                <div className="rotate-[180deg] leading-none scale-[.5] md:scale-[1] md:w-[8vw]">
                ...
                <p className="font-extralight text-[3.5vw] md:text-[2.5vw] ml-2 md:ml-0 leading-none">“Achieve success in the modeling industry with the help of Dupe Model - the UK's leading provider of model development services”</p>
                <div className="mt-[-5vw] md:mt-[-3vw]">
...
export default AftercarePageTwo