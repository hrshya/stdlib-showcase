...
import Model from '../../assets/Images/Aftercare/AftercareModel4.png'


function AftercarePageFour() {
  return (
    <div className="min-h-screen w-full bg-[#242037] font-['Inter'] text-white px-8 py-12 md:px-28 md:py-52 pb-96 md: relative overflow-hidden">
        <div className="md:w-2/3">
            <h1 className="text-[6vw] md:text-[5vw] font-extrabold leading-none">How can New Idol <br /> Models help?</h1>
            <div className="flex flex-col gap-2 md:gap-4 text-[2vw] mt-4 md:text-[1.1vw] md:mt-12">
        ...
        <div className="absolute scale-[.8] md:scale-[.4] xl:scale-[.8] -right-[10vw] -bottom-[5vw] md:right-[-30vw] md:bottom-[-20vw] xl:-right-[10vw] xl:-bottom-[5vw]">
...
export default AftercarePageFour